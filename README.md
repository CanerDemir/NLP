...
#### Detection Author and Language of a Text in Turkish
The aim of the project is determining the author and the language of a given text. I try to define  an appropriate characterization of documents that captures the writing style of the authors, and loading any corpus of languages.
...
I expect to using OpenNLP tools.
